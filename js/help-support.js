...
function categorySVG(icon, color) {
  var svgMap = {
    ...
    card: '<svg width="24" height="24" viewBox="0 0 24 24" fill="' + color + '" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
      ...
      '<path d="M13.5 4.61039V7.54039C13.5 8.21039 12.96 8.75039 12.29 8.75039H3.21C2.53 8.75039 2 8.19039 2 7.52039C2.01 6.39039 2.46 5.36039 3.21 4.61039C3.96 3.86039 5 3.40039 6.14 3.40039H12.29C12.96 3.40039 13.5 3.94039 13.5 4.61039Z"/>' +
    '</svg>',
    payment: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="' + color + '" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
      '<path d="M2 10H22" stroke-miterlimit="10"/>' +
      '<path d="M11.5502 20.4998H6.44025C2.89025 20.4998 1.99023 19.6198 1.99023 16.1098V7.88977C1.99023 4.70977 2.73026 3.68977 5.52026 3.52977C5.80026 3.51977 6.11025 3.50977 6.44025 3.50977H17.5502C21.1002 3.50977 22.0002 4.38977 22.0002 7.89977V12.3098"/>' +
      '<path opacity="0.4" d="M6 16H10" stroke-miterlimit="10"/>' +
      '<path opacity="0.4" d="M22 18C22 18.75 21.79 19.46 21.42 20.06C20.73 21.22 19.46 22 18 22C16.54 22 15.27 21.22 14.58 20.06C14.21 19.46 14 18.75 14 18C14 15.79 15.79 14 18 14C20.21 14 22 15.79 22 18Z" stroke-miterlimit="10"/>' +
      '<path opacity="0.4" d="M16.4399 17.9995L17.4299 18.9895L19.5599 17.0195"/>' +
    '</svg>',
    shield: '<svg width="26" height="26" viewBox="0 0 24 24" fill="' + color + '" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
      '<path d="M16.8399 13.2696L15.3799 12.4296C15.0499 12.2396 15.0499 11.7596 15.3799 11.5596L16.8399 10.7196C17.4699 10.3596 17.6799 9.54961 17.3199 8.91961C16.9599 8.28961 16.1499 8.07961 15.5199 8.43961L14.0599 9.27961C13.7299 9.46961 13.3099 9.22961 13.3099 8.84961V7.16961C13.3099 6.44961 12.7199 5.84961 11.9899 5.84961C11.2599 5.84961 10.6699 6.43961 10.6699 7.16961V8.84961C10.6699 9.22961 10.2499 9.47961 9.91994 9.27961L8.45994 8.43961C7.82994 8.07961 7.01995 8.28961 6.65995 8.91961C6.29995 9.54961 6.50994 10.3596 7.13994 10.7196L8.59994 11.5596C8.92994 11.7496 8.92994 12.2296 8.59994 12.4296L7.13994 13.2696C6.50994 13.6296 6.29995 14.4396 6.65995 15.0696C7.01995 15.6996 7.82994 15.9096 8.45994 15.5496L9.91994 14.7096C10.2499 14.5196 10.6699 14.7596 10.6699 15.1396V16.8196C10.6699 17.5396 11.2599 18.1396 11.9899 18.1396C12.7199 18.1396 13.3099 17.5496 13.3099 16.8196V15.1396C13.3099 14.7596 13.7299 14.5096 14.0599 14.7096L15.5199 15.5496C16.1499 15.9096 16.9599 15.6996 17.3199 15.0696C17.6899 14.4496 17.4699 13.6396 16.8399 13.2696Z"/>' +
    '</svg>'
  };
  return svgMap[icon] || (
